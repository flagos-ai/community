...
The canonical backend suffixes are: `nvidia`, `metax`, `ascend`, `rocm` (AMD), `cambricon`, `iluvatar`, `kunlunxin`, `mthreads`, `enflame`, `hygon`, `sunrise`, `tsingmicro`. Repositories reuse these suffixes rather than inventing new ones; new backends extend this list through this FEP.
