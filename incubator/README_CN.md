...
2. **准备并提交提案**：复制[项目捐赠提案模板](proposal-template.md)至 `incubator/projects/<项目名>/proposal.md`，填写项目、维护团队、捐赠范围、IP 状况及捐赠后计划，向 community 仓库提交 PR。**注意：提案及后续项目流程档案须使用英文填写**；中文政策文件仅供阅读参考。
