...
> [README_CN.md](/incubator/README_CN.md) 第 7 节归档决议通过后的执行手册。归档是中性退出，执行时注意措辞不带惩罚色彩。
> Runbook for executing an archiving decision under README Section 7. Archiving is a neutral exit; keep all wording non-punitive.
