...
- Before an archiving proposal goes to a TSC vote, it is publicized in the project repository and the community repository for **≥30 days**, with best-effort direct contact to the project maintainers and the contributing party contact;
...
- Negotiated with the contributing party per the SGA trademark terms: return to the contributing party, retain under the alliance, or let registration lapse;
